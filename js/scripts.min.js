...
<<<<<<< HEAD
"use strict";$(document).ready(function(){localStorage.setItem("currentCity","Kyiv");var t,a,e,i,n=localStorage.getItem("currentCity");function o(h){$.get("https://api.openweathermap.org/data/2.5/weather",{q:h,lang:"ua",appid:"64b842bc5c15ff3d37a1f815e7b3bf55"},function(t){t.name==h&&$("#cityName").html($("#cityList option:selected").html());var a=Math.round(t.main.temp-273);$("#temp").html(a+"&#176;C");var e=Math.round(t.main.temp_min-273);$("#minTemp").html('<i class="fas fa-long-arrow-alt-down"></i> '+e+"&#176;C");var i=Math.round(t.main.temp_max-273);$("#maxTemp").html('<i class="fas fa-long-arrow-alt-up"></i> '+i+"&#176;C");var n=t.weather[0].main,o=t.weather[0].icon;$.getJSON("json/weather.json",function(t){for(var a in t)if(n==t[a].name){var e=t[a].uaName;$("#weather").html('<img src="https://openweathermap.org/img/w/'+o+'.png">'+e),$("body").css("backgroundImage","url(img/"+t[a].img+")")}});var r=t.weather[0].description;$("#weatherDescription").html(r.toUpperCase());var l=t.wind.speed;$("#wind").html(l+" км/ч");var m=t.main.humidity;$("#humidity").html(m+"%");var c=t.visibility;c?$("#visibility").html(c/1e3+" км"):$("#visibility").html(Math.round(5*Math.random())+1+" км");var s=t.clouds.all;$("#cloudiness").html(s+"%"),console.log(t)})}t=new Date,a=t.getMonth(),e=t.getDate(),i=["Січень","Лютий","Березень","Квітень","Травень","Червень","Липень","Серпень","Вересень","Жовтень","Листопад","Грудень"][a]+" "+e,$("#date").html(i),localStorage.changedCity?o(localStorage.changedCity):o(n),$("#cityList").change(function(){var t=$("#cityList option:selected").val();localStorage.setItem("changedCity",t),o(t)});for(var r=0;r<$("#cityList option").length;r++)$("#cityList option")[r].value==localStorage.changedCity&&$("#cityList option")[r].setAttribute("selected","selected")});
=======
"use strict";$(document).ready(function(){localStorage.setItem("currentCity","Kyiv");var t,a,e,i,n=localStorage.getItem("currentCity");function o(s){$.get("https://api.openweathermap.org/data/2.5/weather",{q:s,lang:"ua",appid:"64b842bc5c15ff3d37a1f815e7b3bf55"},function(t){t.name==s&&$("#cityName").html($("#cityList option:selected").html());var a=Math.round(t.main.temp-273);$("#temp").html(a+"&#176;C");var e=Math.round(t.main.temp_min-273);$("#minTemp").html('<i class="fas fa-long-arrow-alt-down"></i> '+e+"&#176;C");var i=Math.round(t.main.temp_max-273);$("#maxTemp").html('<i class="fas fa-long-arrow-alt-up"></i> '+i+"&#176;C");var n=t.weather[0].main,o=t.weather[0].icon;$.getJSON("json/weather.json",function(t){for(var a in t)if(n==t[a].name){var e=t[a].uaName;$("#weather").html('<img src="https://openweathermap.org/img/w/'+o+'.png">'+e),$("body").css("backgroundImage","url(img/"+t[a].img+")")}});var r=t.weather[0].description;$("#weatherDescription").html(r.toUpperCase());var l=t.wind.speed;$("#wind").html(l+" км/ч");var m=t.main.humidity;$("#humidity").html(m+"%");var c=t.visibility;c?$("#visibility").html(c/1e3+" км"):$("#visibility").html(Math.round(5*Math.random())+1+" км");var h=t.clouds.all;$("#cloudiness").html(h+"%"),console.log(t)})}t=new Date,a=t.getMonth(),e=t.getDate(),i=["Січень","Лютий","Березень","Квітень","Травень","Червень","Липень","Серпень","Вересень","Жовтень","Листопад","Грудень"][a]+" "+e,$("#date").html(i),localStorage.changedCity?o(localStorage.changedCity):o(n),$("#cityList").change(function(){var t=$("#cityList option:selected").val();localStorage.setItem("changedCity",t),o(t)});for(var r=0;r<$("#cityList option").length;r++)$("#cityList option")[r].value==localStorage.changedCity&&$("#cityList option")[r].setAttribute("selected","selected")});
>>>>>>> dc23628a8be42c1afc5d8874d8d5a39edb3df476
